...
Counts treat hyphenated terms as one word. The landing-copy test checks that
this record matches the rendered text and that each count remains accurate.
...
| Each chore repeats from completion. | 5 | pass |
| Keep your household record private | 5 | pass |
| Export or share a household copy only when you choose. | 10 | pass |
| Household copies do not stay in sync. Scan or import again to update another device. | 15 | pass |
...
| Date after a completion | next due date |
| Isolated trial | demo |
