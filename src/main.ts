...
function landing() {
  ...
  return appShell(
    `<section class="hero"><div class="hero-copy"><p class="eyebrow">A household record, not a scorecard</p><h1 tabindex="-1">Record chores when they get done</h1><p class="lede">For roommates and families who share the work and need to know what is due next.</p><div class="actions"><a class="button primary" href="/demo">Try it with sample data</a><span class="action-note">See a working shared chore board.</span></div><div class="facts"><span>Works offline after setup</span><span>Stored on this device</span><span>Free to use</span></div>${hasData ? `<a class="text-link" href="/log" data-link>Open your chore board →</a>` : `<button class="text-link" data-action="open-add">Add your first chore →</button>`}</div><figure class="hero-art"><img src="/kitchen-diorama.webp" width="1200" height="800" fetchpriority="high" decoding="async" alt="A paper-cut kitchen with a sink, cleaning cloth, plant, and blank receipt." /><figcaption>Keep the outcome. Skip the blame.</figcaption></figure></section>${samplePreview()}<section class="how"><div><p class="section-kicker">How it works</p><h2>One receipt, then a clear next date</h2></div><ol><li><b>Keep a shared list.</b><span>Add chores the household repeats.</span></li><li><b>Tap “Mark done.”</b><span>The time becomes a receipt.</span></li><li><b>Check what is due.</b><span>Each chore repeats from completion.</span></li></ol></section><section class="privacy-note"><h2>Keep your household record private</h2><p>Export or share a household copy only when you choose.</p><p>Household copies do not stay in sync. Scan or import again to update another device.</p><a href="/privacy" data-link>Read the privacy details</a></section>${addDialog()}`,
  );
}
function samplePreview() {
  return `<section class="sample-preview" aria-labelledby="sample-preview-heading"><div class="preview-intro"><p class="section-kicker">Sample board preview</p><h2 id="sample-preview-heading">See a chore receipt at work</h2><p>This is Maple Street home. It is a sample, not your data.</p><a class="text-link" href="/demo">Open the editable sample board →</a></div><div class="preview-board"><div class="preview-board-head"><div><p class="eyebrow">Maple Street home</p><h3>Ready for anyone</h3></div><span class="preview-count">2 due now</span></div><ul class="preview-chores"><li><span class="preview-clip" aria-hidden="true"></span><div><b>Clean the bathroom</b><p><strong>1 day overdue</strong> · repeats every 7 days</p></div><span class="preview-done" aria-label="Sample chore marked done">✓</span></li><li><span class="preview-clip" aria-hidden="true"></span><div><b>Water the plants</b><p>Due in 3 days · repeats every 5 days</p></div><span class="preview-done" aria-label="Sample chore marked done">✓</span></li></ul><div class="preview-receipt"><span class="stamp" aria-hidden="true">✓</span><div><b>Water the plants</b><span class="preview-receipt-copy">Done Aug 26 · next Aug 31</span></div></div></div></section>`;
}
